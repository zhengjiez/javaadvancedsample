...
public class TimeSearch
{
   ...
   public static void main(String[] args) 
   {
      ...
      // Generate an ArrayList that contains UNIQUE numbers.
      ...
      // Copy numbers from ArrayList to an integer list.
      int[] numbers = new int[size];
      for (int i = 0; i < nums.size(); ++i) {
         numbers[i] = (Integer)nums.get(i);
      }

      // Get a number for linear search from user input.
      ...
      // Get a number for binary search from user input.
      Arrays.sort(numbers);
      System.out.print("Enter a number to search for: ");
      num = input.nextInt();
